...
required_dirs = [
    ...
    root / 'knowledge' / 'knowledge-graph',
    root / 'knowledge' / 'ux-laws',
    root / 'knowledge' / 'token-intelligence',
    root / 'knowledge' / 'anti-patterns',
    root / 'knowledge' / 'migration-intelligence',
    root / 'knowledge' / 'governance',
    root / 'knowledge' / 'human-override',
    root / 'knowledge' / 'risk-register',
    root / 'knowledge' / 'visual-regression',
    root / 'knowledge' / 'documentation-os',
    root / 'knowledge' / 'version-memory',
    root / 'knowledge' / 'organization-intelligence',
    root / 'knowledge' / 'economic-optimization',
    root / 'knowledge' / 'executive-review',
    root / 'knowledge' / 'portfolio-intelligence',
    root / 'knowledge' / 'institutional-memory',
    root / 'knowledge' / 'tradeoff-engine',
    root / 'knowledge' / 'assumption-registry',
    root / 'knowledge' / 'uncertainty-engine',
    root / 'knowledge' / 'contradiction-detector',
    root / 'knowledge' / 'future-proofing',
    root / 'knowledge' / 'complexity-budget',
    root / 'knowledge' / 'stakeholder-simulation',
    root / 'knowledge' / 'user-journey-simulator',
    root / 'knowledge' / 'cognitive-load',
    root / 'knowledge' / 'accessibility-beyond-wcag',
    root / 'knowledge' / 'design-debt',
    root / 'knowledge' / 'innovation-engine',
    root / 'knowledge' / 'organization-brain',
    root / 'knowledge' / 'portfolio-optimizer',
    root / 'knowledge' / 'strategic-alignment',
    root / 'knowledge' / 'executive-dashboard',
    root / 'knowledge' / 'benchmark-evolution',
    root / 'knowledge' / 'ai-governance',
    root / 'compliance',
    root / 'results',
    root / 'reports',
    root / 'governance',
